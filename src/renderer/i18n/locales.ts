...
const zhCN: TranslationMap = {
  ...
  'settings.general.firstRunWizard.description': '打开后会重新显示第一次启动时的向导，可选择 WASAPI Shared、安全模式、Exclusive 或 ASIO；完成或跳过后会自动关闭这个开关。',
  ...
  'settings.playback.gapless.description': '本地同专辑相邻曲目 0 秒间隔，不淡入淡出；安全模式会临时转入原生 shared 链路。Automix 暂停期间保持独立。',
  ...
  'settings.playback.outputMode.description': '普通耳机、蓝牙和电脑扬声器建议使用 WASAPI Shared。安全模式是浏览器兼容兜底；ASIO / Exclusive 适合外置声卡和 HiFi 调试。',
...
const zhTW: TranslationMap = {
  ...
  'settings.general.firstRunWizard.description': '開啟後會重新顯示第一次啟動時的向導，可選擇 WASAPI Shared、安全模式、Exclusive 或 ASIO；完成或略過後會自動關閉這個開關。',
  ...
  'settings.playback.outputMode.asio': 'ASIO',
  'settings.playback.outputMode.description': '普通耳機、藍牙和電腦喇叭建議使用 WASAPI Shared。安全模式是瀏覽器相容兜底；ASIO / Exclusive 適合外接音效卡和 HiFi 調試。',
  'settings.playback.outputMode.exclusive': 'Exclusive',
  ...
  'settings.playback.fixedVolume.status.fixed': '已固定',
  'settings.playback.fixedVolume.title': '固定音量',
  'settings.playback.gapless.description': '本機同專輯相鄰曲目 0 秒間隔，不淡入淡出；安全模式會暫時轉入原生 shared 鏈路。Automix 暫停期間保持獨立。',
...
const jaJP: TranslationMap = {
  ...
  'settings.general.firstRunWizard.description': '有効にすると初回起動時のガイドをもう一度表示し、WASAPI Shared、安全モード、Exclusive、ASIO を選べます。完了またはスキップ後、このスイッチは自動でオフになります。',
  ...
  'settings.playback.fixedVolume.title': '固定音量',
  'settings.playback.gapless.description': 'ローカルの同一アルバムで隣接する曲だけを 0 秒間隔で再生します。安全モードでは一時的にネイティブ shared 経路を使い、Automix 停止中も独立して動作します。',
  ...
  'settings.playback.outputMode.description': '一般的なヘッドホン、Bluetooth、PC スピーカーには WASAPI Shared を推奨します。安全モードはブラウザー互換の退避用です。ASIO / Exclusive は外部オーディオ機器や HiFi 調整向けです。',
  'settings.playback.outputMode.exclusive': 'Exclusive',
...
const enUS: TranslationMap = {
  ...
  'settings.general.firstRunWizard.description': 'Show the first-run guide again after opening. You can choose WASAPI Shared, Safe Mode, Exclusive, or ASIO; this switch turns off automatically after finishing or skipping.',
  ...
  'settings.playback.gapless.description': '0-second gaps for adjacent local tracks from the same album. Safe Mode temporarily uses the native shared path; this stays separate while Automix is paused.',
  ...
  'settings.playback.outputMode.description': 'Use WASAPI Shared for headphones, Bluetooth, and computer speakers. Safe Mode is a browser-compatible fallback; ASIO / Exclusive are for external audio interfaces and HiFi debugging.',
  'settings.playback.outputMode.exclusive': 'Exclusive',
